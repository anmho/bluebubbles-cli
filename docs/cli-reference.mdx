...
- `--renderer <name>` for human table rendering (`columnify`, `compact`)
...
- `bluebubbles server local start`
  Local process manager, no remote API endpoint
- `bluebubbles server local status`
  Local process manager, no remote API endpoint
- `bluebubbles server local stop [--yes]`
  Local process manager, no remote API endpoint
- `bluebubbles server local restart [--yes]`
  Local process manager, no remote API endpoint
